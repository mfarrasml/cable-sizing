...
namespace Test1
{
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            ka2dt.Rows.Add("Perforated cable tray system", "Touching", "1", "1", "0,88", "0,82", "0,79", "0,76", "0,73");
            ka2dt.Rows.Add("Perforated cable tray system", "Touching", "2", "1", "0,87", "0,8", "0,77", "0,73", "0,68");
            ka2dt.Rows.Add("Perforated cable tray system", "Touching", "3", "1", "0,86", "0,79", "0,76", "0,71", "0,66");
            ka2dt.Rows.Add("Perforated cable tray system", "Touching", "6", "1", "0,84", "0,77", "0,73", "0,68", "0,64");
            ka2dt.Rows.Add("Perforated cable tray system", "Spaced", "1", "1", "1", "0,98", "0,95", "0,91", "0");
            ka2dt.Rows.Add("Perforated cable tray system", "Spaced", "2", "1", "0,99", "0,96", "0,92", "0,87", "0");
            ka2dt.Rows.Add("Perforated cable tray system", "Spaced", "3", "1", "0,98", "0,95", "0,91", "0,85", "0");

            ka2dt.Rows.Add("Vertical perforated cable tray system", "Touching", "1", "1", "0,88", "0,82", "0,78", "0,73", "0,72");
            ka2dt.Rows.Add("Vertical perforated cable tray system", "Touching", "2", "1", "0,88", "0,81", "0,76", "0,71", "0,70");
            ka2dt.Rows.Add("Vertical perforated cable tray system", "Spaced", "1", "1", "0,91", "0,89", "0,88", "0,87", "0");
            ka2dt.Rows.Add("Vertical perforated cable tray system", "Spaced", "2", "1", "0,91", "0,88", "0,87", "0,85", "0");
            ...
            ka2dt.Rows.Add("Cable ladder systems, cleats, etc.", "Touching", "1", "1", "0,87", "0,82", "0,80", "0,79", "0,78");
            ka2dt.Rows.Add("Cable ladder systems, cleats, etc.", "Touching", "2", "1", "0,86", "0,80", "0,78", "0,76", "0,73");
            ka2dt.Rows.Add("Cable ladder systems, cleats, etc.", "Touching", "3", "1", "0,85", "0,79", "0,76", "0,73", "0,70");
            ka2dt.Rows.Add("Cable ladder systems, cleats, etc.", "Touching", "6", "1", "0,84", "0,77", "0,73", "0,68", "0,64");
